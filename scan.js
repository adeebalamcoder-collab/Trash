/* =========================================================
   Bharat.io – QR Scan Engine (Stable Production Version)
========================================================= */
...
function showNotRegistered(qrId){
...
<a href="register.html?id=${encodeURIComponent(qrId)}"
...
<p>
The user has disabled public contact
access for this QR profile.
</p>
...
This contact profile is provided
through Bharat.io.

Please use responsibly
for genuine communication only.
...
console.error("ownerData container missing");
return;
...
const consent =
normalize(record["Consent (Required)"])
.toLowerCase();
...
const card =
document.querySelector(".owner-card");
